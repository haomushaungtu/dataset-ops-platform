...
| --- | --- | --- | --- | --- | --- |
| OpenMetadata | `opensource/openmetadata` | `haomushaungtu/OpenMetadata` | `open-metadata/OpenMetadata` | `f329dd4a7e47134a2bd5a06af6181b0ee527ddd9` | 无，等待一期产品定制提交 |
...
| --- | --- | --- | --- |
| OpenMetadata | 1.13.0 release (`f329dd4a`) | 自有 Fork/Submodule 已固定；在 Linux 完成后端/UI 构建；主题/中文/菜单/自定义属性/质量摘要/SSO；使用隔离搜索实例 | 完整构建日志、提交哈希、补丁清单、UI/API 冒烟 |
